...
```none
Launch a AWS EC2 instance t2.xlarge, 1T SSD
```
...
# download original 7B, 13B, 30B, 65B Llama model weights (219 GB)
...
# prepare python virtual environment for conversion/quantizing
...
# quantize model to 4-bits using model 7B as an example (using q4_0 method)
